...
func TestReadFields(t *testing.T) {
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			expectedFields := make([]*prowlarr.Field, 1)
			expectedFields[0] = prowlarr.NewField()
...
func TestWriteFields(t *testing.T) {
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			fields := make([]*prowlarr.Field, 1)
			fields[0] = prowlarr.NewField()
